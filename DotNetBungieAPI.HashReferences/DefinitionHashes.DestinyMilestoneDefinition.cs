namespace DotNetBungieAPI.HashReferences
{
	public static partial class DefinitionHashes
	{
		public static class Milestones
		{
			...
			/// </summary>
			public const uint TheFinalShape = 1269958029;
			/// <summary>
			...
			/// <summary>
			/// 	Complete Cooperative Focus mission "Ascent."
			/// </summary>
			public const uint Ascent_1952013998 = 1952013998;
			/// <summary>
			/// 	({var:3624160918} of 3) Complete ritual activities.
			/// </summary>
			...
			/// </summary>
			public const uint EnterprisingExplorerII = 373284212;
			/// <summary>
			/// 	Complete Breach Executable on any difficulty.
			/// </summary>
			public const uint EnterprisingExplorerIII = 373284213;
			/// <summary>
			/// 	Complete the mission "A Guardian Rises."
			/// </summary>
			public const uint AGuardianRises = 3862169973;
			/// <summary>
			/// 	Complete a Pathfinder path and claim the reward.
			/// </summary>
			...
			/// 	Free the Light.
			/// </summary>
			public const uint SalvationsEdge = 4196566271;
			/// <summary>
			...
			/// 	Complete Cooperative Focus mission "Ascent."
			/// </summary>
			public const uint Ascent_1842744102 = 1842744102;
		}
	}
}
