...
namespace NetBungieAPI.Models.Content
{
    ...
    {
        [JsonPropertyName("contentId"), JsonNumberHandling(JsonNumberHandling.AllowReadingFromString)]
        ...
        public ReadOnlyDictionary<string, object> Properties { get; init; } = Defaults.EmptyReadOnlyDictionary<string, object>();

        [JsonPropertyName("representations")]
        public ReadOnlyCollection<ContentRepresentation> Representations { get; init; } = Defaults.EmptyReadOnlyCollection<ContentRepresentation>();
