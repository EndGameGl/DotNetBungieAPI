...
namespace NetBungieAPI.Models.Forum
{
    public sealed record PostResponse
    {
        ...
        [JsonPropertyName("latestReplyPostId"), JsonNumberHandling(JsonNumberHandling.AllowReadingFromString)]
        public long LatestReplyPostId { get; init; }

        [JsonPropertyName("latestReplyAuthorId"), JsonNumberHandling(JsonNumberHandling.AllowReadingFromString)]
