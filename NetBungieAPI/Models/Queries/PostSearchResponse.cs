...
namespace NetBungieAPI.Models.Queries
{
    public sealed record PostSearchResponse : SearchResultBase
    {
        ...
        public ReadOnlyCollection<PostResponse> RelatedPosts { get; init; } = Defaults.EmptyReadOnlyCollection<PostResponse>();

        [JsonPropertyName("authors")]
        public ReadOnlyCollection<GeneralUser> Authors { get; init; } = Defaults.EmptyReadOnlyCollection<GeneralUser>();

        [JsonPropertyName("groups")]
        public ReadOnlyCollection<GroupResponse> Groups { get; init; } = Defaults.EmptyReadOnlyCollection<GroupResponse>();

        [JsonPropertyName("searchedTags")]
        public ReadOnlyCollection<TagResponse> SearchedTags { get; init; } = Defaults.EmptyReadOnlyCollection<TagResponse>();
        ...
        public ReadOnlyCollection<ForumRecruitmentDetail> RecruitmentDetails { get; init; } = Defaults.EmptyReadOnlyCollection<ForumRecruitmentDetail>();
