...
namespace NetBungieAPI.Models.Destiny.Profiles
{
    ...
    ///     entirely separate systems with their own logic, and the one we source this data from should be considered
    ///     non-authoritative in comparison.
    /// </summary>
    public sealed record DestinyProfileTransitoryCurrentActivity
    {
        ...
        /// <summary>
        ///     If you're still in it but it "ended" (like when folks are dancing around the loot after they beat a boss), this is
