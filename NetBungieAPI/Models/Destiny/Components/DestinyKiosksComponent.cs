...
using NetBungieAPI.Models.Destiny.Kiosks;
...
namespace NetBungieAPI.Models.Destiny.Components
{
    ...
    public sealed record DestinyKiosksComponent
    {
        ...
        public ReadOnlyDictionary<DefinitionHashPointer<DestinyVendorDefinition>, ReadOnlyCollection<DestinyKioskItem>> KioskItems { get; init; } =
            Defaults.EmptyReadOnlyDictionary<DefinitionHashPointer<DestinyVendorDefinition>, ReadOnlyCollection<DestinyKioskItem>>();
    }
}