...
{
    /// <summary>
    ///     Request this component if you want the details about an item being sold in relation to the character making the
    ///     request: whether the character can buy it, whether they can afford it, and other data related to purchasing the
    ///     item.
    ///     <para />
    ///     Note that if you want instance, stats, etc... data for the item, you'll have to request additional components such
    ///     as ItemInstances, ItemPerks etc... and acquire them from the DestinyVendorResponse's "items" property.
    /// </summary>
    public sealed record DestinyVendorSaleItemComponent
    {
        /// <summary>
        ///     A flag indicating whether the requesting character can buy the item, and if not the reasons why the character can't
        ///     buy it.
        /// </summary>
        ...
        /// <summary>
        ///     If you can't buy the item due to a complex character state, these will be hashes for DestinyUnlockDefinitions that
        ///     you can check to see messages regarding the failure (if the unlocks have human readable information: it is not
        ///     guaranteed that Unlocks will have human readable strings, and your application will have to handle that)
        ///     <para />
        ...
        ///     reliable failure information for why you can't purchase an item.
        ///     <para />
        ///     It is preferred to use these over requiredUnlocks and unlockStatuses: the latter are provided mostly in case
        ...
        ///     meant to correspond with some sort of visual indicator as to the augmentation: for instance, if an item is on sale
        ///     or if you already own the item in question.
        ///     <para />
        ///     Determining how you want to represent these in your own app (or if you even want to) is an exercise left for the
        ///     reader.
        /// </summary>
