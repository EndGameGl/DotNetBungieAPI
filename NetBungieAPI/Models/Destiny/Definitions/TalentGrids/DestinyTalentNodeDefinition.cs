...
namespace NetBungieAPI.Models.Destiny.Definitions.TalentGrids
{
    ...
    public sealed record DestinyTalentNodeDefinition : IDeepEquatable<DestinyTalentNodeDefinition>
    {
        ...
        /// <summary>
        /// Talent nodes can be associated with a piece of Lore, generally rendered in a tooltip. This is the DestinyLoreDefinition of the lore element to show, if there is one to be show.
        /// </summary>
