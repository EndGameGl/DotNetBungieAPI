...
using Unity;
using DefaultDestiny2DefinitionRepository = NetBungieAPI.Services.Default.DefaultDestiny2DefinitionRepository;
    ...
    public sealed class BungieClientConfiguration
    {
            ...
            Action<DefaultDestiny2DefinitionRepositoryConfiguration> configure)
        {
            ...
            StaticUnityContainer.Container
                .RegisterType<IDestiny2DefinitionRepository, DefaultDestiny2DefinitionRepository>(TypeLifetime
                    .Singleton);
            return this;
        }
