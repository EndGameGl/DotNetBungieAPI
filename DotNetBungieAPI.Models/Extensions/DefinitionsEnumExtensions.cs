...
public static class DefinitionsEnumExtensions
{
    ...
    public static string ToStringFast(this DefinitionsEnum definitionsEnum) =>
        definitionsEnum switch
        {
            ...
            DefinitionsEnum.DestinyGlobalConstantsDefinition => nameof(DefinitionsEnum.DestinyGlobalConstantsDefinition),
            ...
            DefinitionsEnum.DestinyIconDefinition => nameof(DefinitionsEnum.DestinyIconDefinition),
