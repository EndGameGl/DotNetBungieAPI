...
public sealed class DestinyMilestone
{
    ...
    public Destiny.Milestones.DestinyMilestoneQuest[]? AvailableQuests { get; init; }
    ...
    public Destiny.Milestones.DestinyMilestoneChallengeActivity[]? Activities { get; init; }
    ...
    public Destiny.Milestones.DestinyMilestoneVendor[]? Vendors { get; init; }
    ...
    public Destiny.Milestones.DestinyMilestoneRewardCategory[]? Rewards { get; init; }
