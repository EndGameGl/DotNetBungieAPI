...
public sealed record DestinyPublicMilestoneChallengeActivity
{
    ...
    /// <summary>
    ///     The ordered list of phases for this activity, if any. Note that we have no human readable info for phases, nor any
    ...
    public ReadOnlyCollection<uint> PhaseHashes { get; init; } = ReadOnlyCollection<uint>.Empty;
    ...
    ///     Mode".
    ///     <para />
    ///     We have no human readable information for this data, so it's up to you if you want to associate it with such info
    ///     to show it.
    /// </summary>
