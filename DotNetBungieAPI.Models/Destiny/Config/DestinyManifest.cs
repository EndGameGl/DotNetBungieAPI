...
public sealed class DestinyManifest
{
    ...
    public Destiny.Config.GearAssetDataBaseDefinition[]? MobileGearAssetDataBases { get; init; }
    ...
    public Destiny.Config.ImagePyramidEntry[]? IconImagePyramidInfo { get; init; }
}
