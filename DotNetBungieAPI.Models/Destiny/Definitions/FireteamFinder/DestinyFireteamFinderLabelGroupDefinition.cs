...
public sealed class DestinyFireteamFinderLabelGroupDefinition : IDestinyDefinition, IDisplayProperties
{
    public DefinitionsEnum DefinitionEnumValue => DefinitionsEnum.DestinyFireteamFinderLabelGroupDefinition;
