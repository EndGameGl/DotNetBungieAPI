...
public sealed class DestinyActivityDefinition : IDestinyDefinition
{
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyPlaceDefinition> PlaceHash { get; init; }
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyActivityTypeDefinition> ActivityTypeHash { get; init; }
    ...
    public Destiny.Definitions.DestinyActivityRewardDefinition[]? Rewards { get; init; }
    ...
    public Destiny.Definitions.DestinyActivityModifierReferenceDefinition[]? Modifiers { get; init; }
    ...
    public Destiny.Definitions.DestinyActivityChallengeDefinition[]? Challenges { get; init; }
    ...
    public Destiny.Definitions.DestinyActivityUnlockStringDefinition[]? OptionalUnlockStrings { get; init; }

    [JsonPropertyName("activityFamilyHashes")]
    public DefinitionHashPointer<Destiny.Definitions.Activities.DestinyActivityFamilyDefinition>[]? ActivityFamilyHashes { get; init; }
    ...
    public Destiny.Definitions.DestinyActivityPlaylistItemDefinition[]? PlaylistItems { get; init; }
    ...
    public Destiny.Definitions.DestinyActivityGraphListEntryDefinition[]? ActivityGraphList { get; init; }
    ...
    public Destiny.Definitions.DestinyActivityLoadoutRequirementSet[]? Loadouts { get; init; }
    ...
    public Destiny.Definitions.DestinyActivityInsertionPointDefinition[]? InsertionPoints { get; init; }
