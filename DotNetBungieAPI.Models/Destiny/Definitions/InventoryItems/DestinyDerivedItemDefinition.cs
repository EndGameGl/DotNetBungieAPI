...
/// <summary>
///     This is a reference to, and summary data for, a specific item that you can get as a result of Using or Acquiring
///     some other Item (For example, this could be summary information for an Emote that you can get by opening an an
///     Eververse Box)
/// </summary>
public sealed record DestinyDerivedItemDefinition : IDeepEquatable<DestinyDerivedItemDefinition>
{
    /// <summary>
    ///     DestinyInventoryItemDefinition of this derived item, if there is one. Sometimes we are given this information as a
    ///     manual override, in which case there won't be an actual DestinyInventoryItemDefinition for what we display, but you
    ///     can still show the strings from this object itself.
    /// </summary>
