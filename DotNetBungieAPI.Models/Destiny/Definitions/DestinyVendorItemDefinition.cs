...
public sealed class DestinyVendorItemDefinition
{
    ...
    public Destiny.Definitions.DestinyVendorItemQuantity[]? Currencies { get; init; }
    ...
    public Destiny.Definitions.DestinyItemCreationEntryLevelDefinition[]? CreationLevels { get; init; }
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyInventoryBucketDefinition> InventoryBucketHash { get; init; }
    ...
    public int[]? RedirectToSaleIndexes { get; init; }

    [JsonPropertyName("socketOverrides")]
    public Destiny.Definitions.DestinyVendorItemSocketOverride[]? SocketOverrides { get; init; }
