...
public sealed class DestinyItemQualityBlockDefinition
{
    ...
    public int[]? ItemLevels { get; init; }
    ...
    public uint[]? InfusionCategoryHashes { get; init; }
    ...
    public DefinitionHashPointer<Destiny.Definitions.Progression.DestinyProgressionLevelRequirementDefinition> ProgressionLevelRequirementHash { get; init; }
    ...
    public Destiny.Definitions.DestinyItemVersionDefinition[]? Versions { get; init; }

    /// <summary>
    ///     Icon overlays to denote the item version and power cap status.
    /// </summary>
    [JsonPropertyName("displayVersionWatermarkIcons")]
    public string[]? DisplayVersionWatermarkIcons { get; init; }
}
