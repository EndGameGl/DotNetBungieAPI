...
public sealed class DestinyPlugSetDefinition : IDestinyDefinition
{
    ...
    public Destiny.Definitions.DestinyItemSocketEntryPlugItemRandomizedDefinition[]? ReusablePlugItems { get; init; }
