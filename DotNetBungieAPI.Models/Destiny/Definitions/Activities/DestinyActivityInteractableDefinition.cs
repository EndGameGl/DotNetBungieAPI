...
public sealed class DestinyActivityInteractableDefinition : IDestinyDefinition
{
    public DefinitionsEnum DefinitionEnumValue => DefinitionsEnum.DestinyActivityInteractableDefinition;

    /// <summary>
    ///     The possible interactables in this activity interactable definition.
    /// </summary>
    [JsonPropertyName("entries")]
    public Destiny.Definitions.Activities.DestinyActivityInteractableEntryDefinition[]? Entries { get; init; }
