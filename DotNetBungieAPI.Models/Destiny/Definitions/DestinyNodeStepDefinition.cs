...
public sealed class DestinyNodeStepDefinition
{
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinySandboxPerkDefinition>[]? PerkHashes { get; init; }
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyStatDefinition>[]? StatHashes { get; init; }
    ...
    public Destiny.Definitions.DestinyNodeSocketReplaceResponse[]? SocketReplacements { get; init; }
}
