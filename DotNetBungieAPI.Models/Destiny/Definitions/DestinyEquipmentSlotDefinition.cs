...
public sealed class DestinyEquipmentSlotDefinition : IDestinyDefinition, IDisplayProperties
{
    ...
    public Destiny.Definitions.DestinyArtDyeReference[]? ArtDyeChannels { get; init; }
