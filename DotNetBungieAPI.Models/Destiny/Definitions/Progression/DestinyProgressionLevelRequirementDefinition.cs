namespace DotNetBungieAPI.Models.Destiny.Definitions.Progression;
...
public sealed class DestinyProgressionLevelRequirementDefinition : IDestinyDefinition
{
    ...
    public Interpolation.InterpolationPointFloat[]? RequirementCurve { get; init; }
