...
public sealed class DestinyVendorDefinition : IDestinyDefinition
{
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyInventoryItemDefinition> DisplayItemHash { get; init; }
    ...
    public string[]? FailureStrings { get; init; }
    ...
    public Dates.DateRange[]? UnlockRanges { get; init; }
    ...
    public Destiny.Definitions.DestinyVendorActionDefinition[]? Actions { get; init; }
    ...
    public Destiny.Definitions.DestinyVendorCategoryEntryDefinition[]? Categories { get; init; }
    ...
    public Destiny.Definitions.DestinyVendorCategoryEntryDefinition[]? OriginalCategories { get; init; }
    ...
    public Destiny.Definitions.DestinyDisplayCategoryDefinition[]? DisplayCategories { get; init; }
    ...
    public Destiny.Definitions.DestinyVendorInteractionDefinition[]? Interactions { get; init; }
    ...
    public Destiny.Definitions.DestinyVendorInventoryFlyoutDefinition[]? InventoryFlyouts { get; init; }
    ...
    public Destiny.Definitions.DestinyVendorItemDefinition[]? ItemList { get; init; }
    ...
    public Destiny.Definitions.DestinyVendorServiceDefinition[]? Services { get; init; }
    ...
    public Destiny.Definitions.DestinyVendorAcceptedItemDefinition[]? AcceptedItems { get; init; }
    ...
    public Destiny.Definitions.Vendors.DestinyVendorLocationDefinition[]? Locations { get; init; }
    ...
    public Destiny.Definitions.DestinyVendorGroupReference[]? Groups { get; init; }
    ...
    public uint[]? IgnoreSaleItemHashes { get; init; }
