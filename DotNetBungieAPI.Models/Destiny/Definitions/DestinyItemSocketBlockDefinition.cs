...
public sealed class DestinyItemSocketBlockDefinition
{
    ...
    public Destiny.Definitions.DestinyItemSocketEntryDefinition[]? SocketEntries { get; init; }
    ...
    public Destiny.Definitions.DestinyItemIntrinsicSocketEntryDefinition[]? IntrinsicSockets { get; init; }
    ...
    public Destiny.Definitions.DestinyItemSocketCategoryDefinition[]? SocketCategories { get; init; }
}
