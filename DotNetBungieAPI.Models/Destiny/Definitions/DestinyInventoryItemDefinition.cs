...
public sealed class DestinyInventoryItemDefinition : IDestinyDefinition, IDisplayProperties
{
    ...
    public Destiny.Definitions.DestinyItemTooltipNotification[]? TooltipNotifications { get; init; }
    ...
    public string IconWatermarkFeatured { get; init; }
    ...
    public Destiny.Definitions.DestinyItemCraftingBlockDefinition? Crafting { get; init; }
    ...
    public Destiny.Definitions.DestinyItemInvestmentStatDefinition[]? InvestmentStats { get; init; }
    ...
    public Destiny.Definitions.DestinyItemPerkEntryDefinition[]? Perks { get; init; }
    ...
    public Destiny.Definitions.Animations.DestinyAnimationReference[]? Animations { get; init; }
    ...
    public Links.HyperlinkReference[]? Links { get; init; }
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyItemCategoryDefinition>[]? ItemCategoryHashes { get; init; }
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyDamageTypeDefinition>[]? DamageTypeHashes { get; init; }
    ...
    public Destiny.DamageType[]? DamageTypes { get; init; }
    ...
    public uint[]? TraitHashes { get; init; }
