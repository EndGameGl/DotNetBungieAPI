...
public sealed class DestinyDestinationDefinition : IDestinyDefinition
{
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyActivityDefinition> DefaultFreeroamActivityHash { get; init; }
    ...
    public Destiny.Definitions.DestinyActivityGraphListEntryDefinition[]? ActivityGraphEntries { get; init; }
    ...
    public Destiny.Definitions.DestinyDestinationBubbleSettingDefinition[]? BubbleSettings { get; init; }
    ...
    public Destiny.Definitions.DestinyBubbleDefinition[]? Bubbles { get; init; }
