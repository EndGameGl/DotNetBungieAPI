...
public sealed class DestinyTalentGridDefinition : IDestinyDefinition
{
    ...
    public Destiny.Definitions.DestinyTalentNodeDefinition[]? Nodes { get; init; }
    ...
    public Destiny.Definitions.DestinyTalentNodeExclusiveSetDefinition[]? ExclusiveSets { get; init; }
    ...
    public int[]? IndependentNodeIndexes { get; init; }
    ...
    public Destiny.Definitions.DestinyTalentNodeCategory[]? NodeCategories { get; init; }
