...
public sealed class DestinyItemPlugDefinition
{
    ...
    public Destiny.Definitions.Items.DestinyPlugRuleDefinition[]? InsertionRules { get; init; }
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyMaterialRequirementSetDefinition> InsertionMaterialRequirementHash { get; init; }
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyInventoryItemDefinition> PreviewItemOverrideHash { get; init; }
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyMaterialRequirementSetDefinition> EnabledMaterialRequirementHash { get; init; }
    ...
    public Destiny.Definitions.Items.DestinyPlugRuleDefinition[]? EnabledRules { get; init; }
