...
public sealed class DestinyItemInventoryBlockDefinition
{
    ...
    public DefinitionHashPointer<Destiny.Definitions.DestinyInventoryBucketDefinition> BucketTypeHash { get; init; }

    /// <summary>
    ///     If the item is picked up by the lost loot queue, this is the hash identifier for the DestinyInventoryBucketDefinition into which it will be placed. Again, I should have named this recoveryBucketHash instead.
    /// </summary>
    [JsonPropertyName("recoveryBucketTypeHash")]
    public DefinitionHashPointer<Destiny.Definitions.DestinyInventoryBucketDefinition> RecoveryBucketTypeHash { get; init; }
    ...
    public DefinitionHashPointer<Destiny.Definitions.Items.DestinyItemTierTypeDefinition> TierTypeHash { get; init; }
