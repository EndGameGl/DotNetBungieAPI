...
public sealed class DestinyCharacterProgressionComponent
{
    ...
    public Dictionary<DefinitionHashPointer<Destiny.Definitions.DestinyProgressionDefinition>, Destiny.DestinyProgression>? Progressions { get; init; }
    ...
    public Dictionary<DefinitionHashPointer<Destiny.Definitions.DestinyFactionDefinition>, Destiny.Progression.DestinyFactionProgression>? Factions { get; init; }
    ...
    public Dictionary<DefinitionHashPointer<Destiny.Definitions.Milestones.DestinyMilestoneDefinition>, Destiny.Milestones.DestinyMilestone>? Milestones { get; init; }
    ...
    public Destiny.Quests.DestinyQuestStatus[]? Quests { get; init; }
    ...
    public Dictionary<DefinitionHashPointer<Destiny.Definitions.DestinyInventoryItemDefinition>, Destiny.Quests.DestinyObjectiveProgress[]>? UninstancedItemObjectives { get; init; }
    ...
    public Dictionary<DefinitionHashPointer<Destiny.Definitions.DestinyInventoryItemDefinition>, Destiny.Entities.Items.DestinyItemPerksComponent>? UninstancedItemPerks { get; init; }
    ...
    public Dictionary<DefinitionHashPointer<Destiny.Definitions.Checklists.DestinyChecklistDefinition>, Dictionary<uint, bool>>? Checklists { get; init; }
