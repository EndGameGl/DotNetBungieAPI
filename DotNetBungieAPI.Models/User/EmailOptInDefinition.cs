...
/// </summary>
public sealed record EmailOptInDefinition
{
    /// <summary>
    ...
    public OptInFlags Value { get; init; }

    /// <summary>
    ///     If true, this opt-in setting should be set by default in situations where accounts are created without explicit
    ///     choices about what they're opting into.
    /// </summary>
