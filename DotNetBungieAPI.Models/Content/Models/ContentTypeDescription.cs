...
public sealed class ContentTypeDescription
{
    ...
    public Content.Models.ContentTypeProperty[]? Properties { get; init; }

    [JsonPropertyName("tagMetadata")]
    public Content.Models.TagMetadataDefinition[]? TagMetadata { get; init; }
    ...
    public Content.Models.ContentPreview[]? Previews { get; init; }

    [JsonPropertyName("suppressCmsPath")]
    public bool SuppressCmsPath { get; init; }

    [JsonPropertyName("propertySections")]
    public Content.Models.ContentTypePropertySection[]? PropertySections { get; init; }
}
