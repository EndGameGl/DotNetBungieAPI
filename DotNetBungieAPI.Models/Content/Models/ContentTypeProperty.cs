...
public sealed class ContentTypeProperty
{
    ...
    public Content.Models.ContentTypeProperty[]? ChildProperties { get; init; }
    ...
    public Content.Models.ContentTypeDefaultValue[]? DefaultValues { get; init; }
    ...
    public string[]? LegalContentTypes { get; init; }
