...
public class GroupMembershipSearchResponse : IDeepEquatable<GroupMembershipSearchResponse>
{
    ...
    public bool DeepEquals(GroupMembershipSearchResponse? other)
    {
    ...
    public void Update(GroupMembershipSearchResponse? other)
    {
