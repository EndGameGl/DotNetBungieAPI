...
public class GroupSearchResponse : IDeepEquatable<GroupSearchResponse>
{
    ...
    public bool DeepEquals(GroupSearchResponse? other)
    {
    ...
    public void Update(GroupSearchResponse? other)
    {
