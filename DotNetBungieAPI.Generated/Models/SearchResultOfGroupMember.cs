...
public class SearchResultOfGroupMember : IDeepEquatable<SearchResultOfGroupMember>
{
    [JsonPropertyName("results")]
    public List<GroupsV2.GroupMember> Results { get; set; }
    ...
    public bool DeepEquals(SearchResultOfGroupMember? other)
    {
    ...
    public void Update(SearchResultOfGroupMember? other)
    {
