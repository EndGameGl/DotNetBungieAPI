...
public class DestinyVendorItemDefinition
{
    ...
    public List<Destiny.Definitions.DestinyVendorItemQuantity> Currencies { get; set; }
    ...
    public List<Destiny.Definitions.DestinyItemCreationEntryLevelDefinition> CreationLevels { get; set; }
    ...
    public List<Destiny.Definitions.DestinyVendorItemSocketOverride> SocketOverrides { get; set; }
