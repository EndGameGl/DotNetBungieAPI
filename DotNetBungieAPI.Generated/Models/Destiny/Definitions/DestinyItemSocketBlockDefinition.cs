...
public class DestinyItemSocketBlockDefinition
{
    ...
    public List<Destiny.Definitions.DestinyItemSocketEntryDefinition> SocketEntries { get; set; }
    ...
    public List<Destiny.Definitions.DestinyItemIntrinsicSocketEntryDefinition> IntrinsicSockets { get; set; }
