...
/// </summary>
public class DestinyDestinationDefinition : IDeepEquatable<DestinyDestinationDefinition>
{
    ...
    public List<Destiny.Definitions.DestinyActivityGraphListEntryDefinition> ActivityGraphEntries { get; set; }
    ...
    public List<Destiny.Definitions.DestinyDestinationBubbleSettingDefinition> BubbleSettings { get; set; }
    ...
    public List<Destiny.Definitions.DestinyBubbleDefinition> Bubbles { get; set; }
