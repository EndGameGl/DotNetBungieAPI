...
public class DestinySocialCommendationDefinition : IDestinyDefinition
{
    ...
    public Destiny.Definitions.Common.DestinyDisplayPropertiesDefinition[]? DisplayActivities { get; set; }
