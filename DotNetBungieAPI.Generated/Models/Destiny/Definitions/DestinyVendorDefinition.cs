...
public class DestinyVendorDefinition : IDeepEquatable<DestinyVendorDefinition>
{
    ...
    public List<Dates.DateRange> UnlockRanges { get; set; }
    ...
    public List<Destiny.Definitions.DestinyVendorActionDefinition> Actions { get; set; }
    ...
    public List<Destiny.Definitions.DestinyVendorCategoryEntryDefinition> Categories { get; set; }
    ...
    public List<Destiny.Definitions.DestinyVendorCategoryEntryDefinition> OriginalCategories { get; set; }
    ...
    public List<Destiny.Definitions.DestinyDisplayCategoryDefinition> DisplayCategories { get; set; }
    ...
    public List<Destiny.Definitions.DestinyVendorInteractionDefinition> Interactions { get; set; }
    ...
    public List<Destiny.Definitions.DestinyVendorInventoryFlyoutDefinition> InventoryFlyouts { get; set; }
    ...
    public List<Destiny.Definitions.DestinyVendorItemDefinition> ItemList { get; set; }
    ...
    public List<Destiny.Definitions.DestinyVendorServiceDefinition> Services { get; set; }
    ...
    public List<Destiny.Definitions.DestinyVendorAcceptedItemDefinition> AcceptedItems { get; set; }
    ...
    public List<Destiny.Definitions.Vendors.DestinyVendorLocationDefinition> Locations { get; set; }
    ...
    public List<Destiny.Definitions.DestinyVendorGroupReference> Groups { get; set; }
