...
public class DestinyFireteamFinderConstantsDefinition : IDestinyDefinition
{
    ...
    public uint[]? FireteamFinderActivityGraphRootCategoryHashes { get; set; }
    ...
    public uint[]? AllFireteamFinderActivityHashes { get; set; }
    ...
    public Destiny.Definitions.Common.DestinyDisplayPropertiesDefinition[]? GuardianOathTenets { get; set; }
