...
public sealed class DestinyItemStatBlockDefinition
{
    ...
    public uint? StatGroupHash { get; init; } // DestinyStatGroupDefinition
    ...
    public Dictionary<uint, Destiny.Definitions.DestinyInventoryItemStatDefinition> Stats { get; init; } // DestinyStatDefinition
    ...
    public uint PrimaryBaseStatHash { get; init; } // DestinyStatDefinition
}
