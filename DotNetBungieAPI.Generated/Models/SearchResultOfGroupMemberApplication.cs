...
public class SearchResultOfGroupMemberApplication : IDeepEquatable<SearchResultOfGroupMemberApplication>
{
    [JsonPropertyName("results")]
    public List<GroupsV2.GroupMemberApplication> Results { get; set; }
    ...
    public bool DeepEquals(SearchResultOfGroupMemberApplication? other)
    {
    ...
    public void Update(SearchResultOfGroupMemberApplication? other)
    {
