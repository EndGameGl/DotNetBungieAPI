...
public class SearchResultOfFireteamSummary : IDeepEquatable<SearchResultOfFireteamSummary>
{
    ...
    public bool DeepEquals(SearchResultOfFireteamSummary? other)
    {
    ...
    public void Update(SearchResultOfFireteamSummary? other)
    {
