...
public class SearchResultOfPostResponse : IDeepEquatable<SearchResultOfPostResponse>
{
    ...
    public bool DeepEquals(SearchResultOfPostResponse? other)
    {
    ...
    public void Update(SearchResultOfPostResponse? other)
    {
