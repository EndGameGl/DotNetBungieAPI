...
namespace NetBungieAPI.Models.User
{
    public sealed record GeneralUser
    {
        ...
        public int ProfilePicture { get; init; }

        [JsonPropertyName("profileTheme")]
        public int ProfileTheme { get; init; }

        [JsonPropertyName("userTitle")]
        public int UserTitle { get; init; }

        [JsonPropertyName("successMessageFlags"), JsonNumberHandling(JsonNumberHandling.AllowReadingFromString)]
        ...
        public string XboxDisplayName { get; init; }

        [JsonPropertyName("fbDisplayName")]
        public string FbDisplayName { get; init; }
        ...
        public long? LastBanReportId { get; init; }
        ...
        public string ProfileThemeName { get; init; }

        [JsonPropertyName("userTitleDisplay")]
        public string UserTitleDisplay { get; init; }
