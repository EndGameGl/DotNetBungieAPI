...
namespace NetBungieAPI.Models.Destiny.Definitions.EnergyTypes
{
    ...
    public class DestinyEnergyTypeDefinition : IDestinyDefinition, IDeepEquatable<DestinyEnergyTypeDefinition>
    {
        ...
        [JsonConstructor]
        internal DestinyEnergyTypeDefinition(DestinyDisplayPropertiesDefinition displayProperties, uint? capacityStatHash, uint costStatHash, DestinyEnergyType enumValue,
