...
namespace NetBungieAPI.Models.Destiny.Definitions.InventoryItems
{
    ...
    public sealed record DestinyItemActionBlockDefinition : IDeepEquatable<DestinyItemActionBlockDefinition>
    {
        ...
        public ReadOnlyCollection<DestinyProgressionRewardDefinition> ProgressionRewards { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyProgressionRewardDefinition>();
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyItemActionRequiredItemDefinition> RequiredItems { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyItemActionRequiredItemDefinition>();
        /// <summary>
