...
namespace NetBungieAPI.Destiny.Definitions.InventoryItems
{
    ...
    public class InventoryItemSocketsBlock : IDeepEquatable<InventoryItemSocketsBlock>
    {
        ...
        /// </summary>
        public ReadOnlyCollection<InventoryItemSocketsBlockIntrinsicSocket> IntrinsicSockets { get; init; }
        /// <summary>
        ...
        /// </summary>
        public ReadOnlyCollection<InventoryItemSocketsBlockSocketCategory> SocketCategories { get; init; }
        /// <summary>
        /// Each non-intrinsic (or mutable) socket on an item is defined here.
        /// </summary>
        public ReadOnlyCollection<InventoryItemSocketsBlockSocketEntry> SocketEntries { get; init; }
