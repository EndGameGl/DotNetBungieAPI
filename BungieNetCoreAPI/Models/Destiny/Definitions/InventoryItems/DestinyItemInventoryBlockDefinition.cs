...
namespace NetBungieAPI.Models.Destiny.Definitions.InventoryItems
{
    ...
    public sealed record DestinyItemInventoryBlockDefinition : IDeepEquatable<DestinyItemInventoryBlockDefinition>
    {
        ...
        public DefinitionHashPointer<DestinyInventoryBucketDefinition> BucketType { get; init; } = DefinitionHashPointer<DestinyInventoryBucketDefinition>.Empty;
        /// <summary>
        ...
        public DefinitionHashPointer<DestinyInventoryBucketDefinition> RecoveryBucketType { get; init; } = DefinitionHashPointer<DestinyInventoryBucketDefinition>.Empty;
