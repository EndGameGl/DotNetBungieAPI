...
namespace NetBungieAPI.Models.Destiny.Definitions.InventoryItems
{
    ...
    public sealed record DestinyItemObjectiveBlockDefinition : IDeepEquatable<DestinyItemObjectiveBlockDefinition>
    {
        ...
        public ReadOnlyCollection<DefinitionHashPointer<DestinyActivityDefinition>> DisplayActivities { get; init; } = Defaults.EmptyReadOnlyCollection<DefinitionHashPointer<DestinyActivityDefinition>>();
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyObjectiveDisplayProperties> PerObjectiveDisplayProperties { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyObjectiveDisplayProperties>();
        /// <summary>
