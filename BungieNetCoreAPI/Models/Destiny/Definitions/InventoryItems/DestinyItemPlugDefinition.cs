...
namespace NetBungieAPI.Models.Destiny.Definitions.InventoryItems
{
    ...
    public sealed record DestinyItemPlugDefinition : IDeepEquatable<DestinyItemPlugDefinition>
    {
        ...
        public ReadOnlyCollection<DestinyPlugRuleDefinition> InsertionRules { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyPlugRuleDefinition>();
        /// <summary>
        ...
        public DefinitionHashPointer<DestinyMaterialRequirementSetDefinition> InsertionMaterialRequirement { get; init; } = DefinitionHashPointer<DestinyMaterialRequirementSetDefinition>.Empty;
        /// <summary>
        ...
        public DefinitionHashPointer<DestinyInventoryItemDefinition> PreviewItemOverride { get; init; } = DefinitionHashPointer<DestinyInventoryItemDefinition>.Empty;
        /// <summary>
        ...
        /// </summary>
        [JsonPropertyName("previewItemOverrideHash")]
        public DefinitionHashPointer<DestinyMaterialRequirementSetDefinition> EnabledMaterialRequirement { get; init; } = DefinitionHashPointer<DestinyMaterialRequirementSetDefinition>.Empty;
        /// <summary>
