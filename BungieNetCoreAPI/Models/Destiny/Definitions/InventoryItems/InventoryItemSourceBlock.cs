...
namespace NetBungieAPI.Destiny.Definitions.InventoryItems
{
    ...
    public class InventoryItemSourceBlock : IDeepEquatable<InventoryItemSourceBlock>
    {
        ...
        public ReadOnlyCollection<InventoryItemSourceBlockSource> Sources { get; init; }
        public BungieMembershipType ExclusiveTo { get; init; }
        public ReadOnlyCollection<InventoryItemSourceBlockVendorSource> VendorSources { get; init; }
