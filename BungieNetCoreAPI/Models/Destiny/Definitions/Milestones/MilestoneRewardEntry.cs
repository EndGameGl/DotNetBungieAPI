...
namespace NetBungieAPI.Destiny.Definitions.Milestones
{
    public class MilestoneRewardEntry : IDeepEquatable<MilestoneRewardEntry>
    {
        ...
        /// </summary>
        public ReadOnlyCollection<MilestoneItem> Items { get; init; }
        /// <summary>
        ...
        [JsonConstructor]
        internal MilestoneRewardEntry(DestinyDisplayPropertiesDefinition displayProperties, MilestoneItem[] items, int order, uint rewardEntryHash, 
