...
namespace NetBungieAPI.Destiny.Definitions.Milestones
{
    public class MilestoneQuest : IDeepEquatable<MilestoneQuest>
    {
        ...
        /// </summary>
        public MilestoneQuestRewardItems QuestRewards { get; init; }
        /// <summary>
        ...
        public ReadOnlyDictionary<DefinitionHashPointer<DestinyActivityDefinition>, MilestoneQuestActivity> Activities { get; init; }

        [JsonConstructor]
        internal MilestoneQuest(DestinyDisplayPropertiesDefinition displayProperties, uint questItemHash, MilestoneQuestRewardItems questRewards,
