...
namespace NetBungieAPI.Models.Destiny.Definitions.Milestones
{
    ...
    public class DestinyMilestoneDefinition : IDestinyDefinition, IDeepEquatable<DestinyMilestoneDefinition>
    {
        ...
        /// </summary>
        public ReadOnlyCollection<MilestoneActivities> Activities { get; init; }
        ...
        /// </summary>
        public ReadOnlyDictionary<DefinitionHashPointer<DestinyInventoryItemDefinition>, MilestoneQuest> Quests { get; init; }
        /// <summary>
        ...
        /// </summary>
        public ReadOnlyDictionary<uint, MilestoneReward> Rewards { get; init; }
        /// <summary>
        ...
        /// </summary>
        public ReadOnlyCollection<MilestoneVendor> Vendors { get; init; }
        /// <summary>
        ...
        /// </summary>
        public ReadOnlyDictionary<string, MilestoneValue> Values { get; init; }
        ...
        [JsonConstructor]
        internal DestinyMilestoneDefinition(int defaultOrder, DestinyDisplayPropertiesDefinition displayProperties, bool explorePrioritizesActivityImage,
