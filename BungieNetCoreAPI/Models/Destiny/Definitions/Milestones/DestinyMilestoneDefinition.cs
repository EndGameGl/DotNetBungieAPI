...
namespace NetBungieAPI.Models.Destiny.Definitions.Milestones
{
    ...
    public sealed record DestinyMilestoneDefinition : IDestinyDefinition, IDeepEquatable<DestinyMilestoneDefinition>
    {
        ...
        public ReadOnlyDictionary<DefinitionHashPointer<DestinyInventoryItemDefinition>, DestinyMilestoneQuestDefinition> Quests { get; init; } = Defaults.EmptyReadOnlyDictionary<DefinitionHashPointer<DestinyInventoryItemDefinition>, DestinyMilestoneQuestDefinition>();
        /// <summary>
        ...
        public ReadOnlyDictionary<uint, DestinyMilestoneRewardCategoryDefinition> Rewards { get; init; } = Defaults.EmptyReadOnlyDictionary<uint, DestinyMilestoneRewardCategoryDefinition>();
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyMilestoneVendorDefinition> Vendors { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyMilestoneVendorDefinition>();
        /// <summary>
        /// Sometimes, milestones will have arbitrary values associated with them that are of interest to us or to third party developers. This is the collection of those values' definitions, keyed by the identifier of the value and providing useful definition information such as localizable names and descriptions for the value.
        /// </summary>
        [JsonPropertyName("values")]
        public ReadOnlyDictionary<string, DestinyMilestoneValueDefinition> Values { get; init; } = Defaults.EmptyReadOnlyDictionary<string, DestinyMilestoneValueDefinition>();
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyMilestoneChallengeActivityDefinition> Activities { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyMilestoneChallengeActivityDefinition>();
