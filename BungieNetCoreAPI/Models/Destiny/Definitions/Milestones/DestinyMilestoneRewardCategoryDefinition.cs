...
namespace NetBungieAPI.Models.Destiny.Definitions.Milestones
{
    ...
    /// </summary>
    public sealed record DestinyMilestoneRewardCategoryDefinition : IDeepEquatable<DestinyMilestoneRewardCategoryDefinition>
    {
        /// <summary>
        ...
        public ReadOnlyDictionary<uint, DestinyMilestoneRewardEntryDefinition> RewardEntries { get; init; } = Defaults.EmptyReadOnlyDictionary<uint, DestinyMilestoneRewardEntryDefinition>();
        /// <summary>
