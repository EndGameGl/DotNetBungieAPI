...
namespace NetBungieAPI.Models.Destiny.Definitions.ItemCategories
{
    ...
    public sealed record DestinyItemCategoryDefinition : IDestinyDefinition, IDeepEquatable<DestinyItemCategoryDefinition>
    {
        ...
        public ReadOnlyCollection<DefinitionHashPointer<DestinyItemCategoryDefinition>> GroupedCategories { get; init; } = Defaults.EmptyReadOnlyCollection<DefinitionHashPointer<DestinyItemCategoryDefinition>>();
        /// <summary>
        ...
        public ReadOnlyCollection<DefinitionHashPointer<DestinyItemCategoryDefinition>> ParentCategories { get; init; } = Defaults.EmptyReadOnlyCollection<DefinitionHashPointer<DestinyItemCategoryDefinition>>();
        /// <summary>
