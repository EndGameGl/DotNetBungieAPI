...
namespace NetBungieAPI.Models.Destiny.Definitions.Objectives
{
    ...
    public class DestinyObjectiveDefinition : IDestinyDefinition, IDeepEquatable<DestinyObjectiveDefinition>
    {
        ...
        /// </summary>
        public ObjectiveUnlockValueUIStyle ValueStyle { get; init; }
        /// <summary>
        /// The style to use when the objective is completed.
        /// </summary>
        public ObjectiveUnlockValueUIStyle CompletedValueStyle { get; init; }
        /// <summary>
        /// The style to use when the objective is still in progress.
        /// </summary>
        public ObjectiveUnlockValueUIStyle InProgressValueStyle { get; init; }
        ...
        [JsonConstructor]
        internal DestinyObjectiveDefinition(DestinyDisplayPropertiesDefinition displayProperties, bool allowNegativeValue, bool allowOvercompletion, bool allowValueChangeWhenCompleted,
