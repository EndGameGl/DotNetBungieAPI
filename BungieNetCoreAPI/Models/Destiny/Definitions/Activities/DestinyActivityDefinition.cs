...
namespace NetBungieAPI.Models.Destiny.Definitions.Activities
{
    ...
    public sealed record DestinyActivityDefinition : IDestinyDefinition, IDeepEquatable<DestinyActivityDefinition>
    {
        ...
        public DefinitionHashPointer<DestinyPlaceDefinition> Place { get; init; } = DefinitionHashPointer<DestinyPlaceDefinition>.Empty;
        /// <summary>
        /// Activity Type of this Activity
        /// </summary>
        [JsonPropertyName("activityTypeHash")]
        public DefinitionHashPointer<DestinyActivityTypeDefinition> ActivityType { get; init; } = DefinitionHashPointer<DestinyActivityTypeDefinition>.Empty;
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyActivityRewardDefinition> Rewards { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyActivityRewardDefinition>();
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyActivityModifierReferenceDefinition> Modifiers { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyActivityModifierReferenceDefinition>();
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyActivityChallengeDefinition> Challenges { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyActivityChallengeDefinition>();
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyActivityUnlockStringDefinition> OptionalUnlockStrings { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyActivityUnlockStringDefinition>();
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyActivityPlaylistItemDefinition> PlaylistItems { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyActivityPlaylistItemDefinition>();
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyActivityGraphListEntryDefinition> ActivityGraphList { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyActivityGraphListEntryDefinition>();
        /// <summary>
        ...
        public DefinitionHashPointer<DestinyActivityModeDefinition> DirectActivityMode { get; init; } = DefinitionHashPointer<DestinyActivityModeDefinition>.Empty;
        /// <summary>
        ...
        public ReadOnlyCollection<DestinyActivityLoadoutRequirementSet> Loadouts { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyActivityLoadoutRequirementSet>();
        /// <summary>
        /// The activity modes
        /// </summary>
        ...
        public ReadOnlyCollection<DestinyActivityInsertionPointDefinition> InsertionPoints { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyActivityInsertionPointDefinition>();
        /// <summary>
        /// A list of location mappings that are affected by this activity.
        /// </summary>
        [JsonPropertyName("activityLocationMappings")]
        public ReadOnlyCollection<DestinyEnvironmentLocationMapping> ActivityLocationMappings { get; init; } = Defaults.EmptyReadOnlyCollection<DestinyEnvironmentLocationMapping>();
        /// <summary>
