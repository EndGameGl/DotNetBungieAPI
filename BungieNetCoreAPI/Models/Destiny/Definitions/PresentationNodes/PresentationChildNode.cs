...
namespace NetBungieAPI.Destiny.Definitions.PresentationNodes
{
    ...
    {
        public ReadOnlyCollection<PresentationChildNodeCollectible> Collectibles { get; init; }
        public ReadOnlyCollection<PresentationChildNodeMetric> Metrics { get; init; }
        public ReadOnlyCollection<PresentationChildNodePresentationNode> PresentationNodes { get; init; }
        public ReadOnlyCollection<PresentationChildNodeRecord> Records { get; init; }
