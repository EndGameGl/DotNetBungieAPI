...
namespace NetBungieAPI.Models.Destiny.Definitions.ActivityGraphs
{
    ...
    /// </summary>
    public sealed record DestinyActivityGraphConnectionDefinition : IDeepEquatable<DestinyActivityGraphConnectionDefinition>
    {
        [JsonPropertyName("sourceNodeHash")]
        public uint SourceNodeHash { get; init; }

        [JsonPropertyName("destNodeHash")]
        public uint DestinationNodeHash { get; init; }
