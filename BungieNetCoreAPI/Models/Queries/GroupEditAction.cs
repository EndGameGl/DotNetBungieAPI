...
namespace NetBungieAPI.Models.Queries
{
    public class GroupEditAction
    {
        ...
        public GroupHomepage? Homepage { get; init; } = null;
        ...
        public GroupPostPublicity? DefaultPublicity { get; init; } = null;
    }
}
