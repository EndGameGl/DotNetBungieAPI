...
namespace NetBungieAPI.Models.Content
{
    public sealed record ContentTypeProperty
    {
        ...
        public ReadOnlyDictionary<string, string> Attributes { get; init; } = Defaults.EmptyReadOnlyDictionary<string, string>();

        [JsonPropertyName("childProperties")]
        public ReadOnlyCollection<ContentTypeProperty> ChildProperties { get; init; } = Defaults.EmptyReadOnlyCollection<ContentTypeProperty>();
        ...
        public ReadOnlyDictionary<string, string> RepresentationSelection { get; init; } = Defaults.EmptyReadOnlyDictionary<string, string>();

        [JsonPropertyName("defaultValues")]
        public ReadOnlyCollection<ContentTypeDefaultValue> DefaultValues { get; init; } = Defaults.EmptyReadOnlyCollection<ContentTypeDefaultValue>();
