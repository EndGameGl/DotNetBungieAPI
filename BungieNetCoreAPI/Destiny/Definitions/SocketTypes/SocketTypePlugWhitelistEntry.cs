    ...
    public class SocketTypePlugWhitelistEntry
    {
        ...
        private SocketTypePlugWhitelistEntry(uint categoryHash, string categoryIdentifier, List<uint> reinitializationPossiblePlugHashes)
        {
            ...
            if (reinitializationPossiblePlugHashes != null)
            {
                ...
                {
                    ReinitializationPossiblePlugs.Add(new DefinitionHashPointer<DestinyInventoryItemDefinition>(reinitializationPossiblePlugHash, "DestinyInventoryItemDefinition", GlobalDefinitionsCacheRepository.CurrentLocaleLoadContext));
                }
            }
        }
    }
