...
namespace BungieNetCoreAPI.Destiny.Definitions.InventoryItems
{
    ...
    public class InventoryItemSourceBlockSource : IDeepEquatable<InventoryItemSourceBlockSource>
    {
        ...
        /// </summary>
        public int MaxLevelRequired { get; }
        /// <summary>
        /// The stats computed for this level/quality range.
        /// </summary>
        public ReadOnlyDictionary<DefinitionHashPointer<DestinyStatDefinition>, InventoryItemStatsBlockStat> ComputedStats { get; }
        /// <summary>
        /// The DestinyRewardSourceDefinitions found that can spawn the item at this level.
        /// </summary>
        public ReadOnlyCollection<DefinitionHashPointer<DestinyRewardSourceDefinition>> Sources { get; }
        [JsonConstructor]
