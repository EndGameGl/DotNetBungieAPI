...
namespace BungieNetCoreAPI.Destiny.Definitions.Activities
{
    public class ActivityModifierEntry
    {
        ...
        {
            ActivityModifier = new DefinitionHashPointer<DestinyActivityModifierDefinition>(activityModifierHash, "DestinyActivityModifierDefinition", GlobalDefinitionsCacheRepository.CurrentLocaleLoadContext);
        }
    }
}
