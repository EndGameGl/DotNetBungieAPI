...
{
    public class ComponentDestinyProfileRecords
    {
        ...
        [JsonConstructor]
        internal ComponentDestinyProfileRecords(int score, int activeScore, int legacyScore, int lifetimeScore, uint? trackedRecordHash,
