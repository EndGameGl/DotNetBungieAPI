...
{  
    public class ComponentDestinyItemInstance
    {
        ...
        [JsonConstructor]
        internal ComponentDestinyItemInstance(DamageType damageType, uint? damageTypeHash, DestinyStat primaryStat, int itemLevel, int quality,
