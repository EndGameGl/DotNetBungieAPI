...
{
    public class ComponentDestinyCharacterRecords
    {
        ...
        [JsonConstructor]
        internal ComponentDestinyCharacterRecords(uint[] featuredRecordHashes, Dictionary<uint, DestinyRecordComponent> records, uint recordCategoriesRootNodeHash,
