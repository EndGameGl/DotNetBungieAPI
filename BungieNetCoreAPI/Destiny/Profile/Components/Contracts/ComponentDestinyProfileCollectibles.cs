...
{
    public class ComponentDestinyProfileCollectibles
    {
        ...
        [JsonConstructor]
        internal ComponentDestinyProfileCollectibles(uint[] recentCollectibleHashes, uint[] newnessFlaggedCollectibleHashes, 
