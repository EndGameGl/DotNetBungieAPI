...
public class MetricDefinitionGeneratorHandler : BaseDefinitionHandler, IDefinitionHandler
{
    public string FileSubName => nameof(DestinyMetricDefinition);
    public string ClassName => "Metrics";
        ...
        int indentation)
    {
        ...
        foreach (var definition in bungieClient.Repository.GetAll<DestinyMetricDefinition>())
        {
        ...
        {
            if (bungieClient.Repository.TryGetDestinyDefinition<DestinyMetricDefinition>(
