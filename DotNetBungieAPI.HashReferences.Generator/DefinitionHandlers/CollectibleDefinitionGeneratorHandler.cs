...
public class CollectibleDefinitionGeneratorHandler : BaseDefinitionHandler, IDefinitionHandler
{
    public string FileSubName => nameof(DestinyCollectibleDefinition);

    public string ClassName => "Collectibles";
    ...
    )
    {
        ...
        foreach (var definition in bungieClient.Repository.GetAll<DestinyCollectibleDefinition>())
        {
        ...
        {
            if (
                bungieClient.Repository.TryGetDestinyDefinition<DestinyCollectibleDefinition>(
                    value,
                    out var definition
                )
            )
