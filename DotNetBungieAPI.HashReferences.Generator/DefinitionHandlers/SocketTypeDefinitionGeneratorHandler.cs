...
using DotNetBungieAPI.Models.Destiny.Definitions.Sockets;
using DotNetBungieAPI.Service.Abstractions;

namespace DotNetBungieAPI.HashReferences.Generator.DefinitionHandlers;

public class SocketTypeDefinitionGeneratorHandler : BaseDefinitionHandler, IDefinitionHandler
{
    public string FileSubName => nameof(DestinySocketTypeDefinition);

    public string ClassName => "SocketTypes";
    ...
    )
    {
        ...
        foreach (var definition in bungieClient.Repository.GetAll<DestinySocketTypeDefinition>())
        {
        ...
        {
            if (
                bungieClient.Repository.TryGetDestinyDefinition<DestinySocketTypeDefinition>(
                    value,
                    out var definition
                )
            )
