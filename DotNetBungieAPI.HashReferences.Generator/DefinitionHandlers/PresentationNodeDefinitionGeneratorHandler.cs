...
public class PresentationNodeDefinitionGeneratorHandler : BaseDefinitionHandler, IDefinitionHandler
{
    ...
    public async Task Generate(IBungieClient bungieClient, TextWriter textWriter, StringBuilder stringBuilder, int indentation)
    {
        ...
        foreach (var definition in bungieClient.Repository.GetAll<DestinyPresentationNodeDefinition>())
        {
        ...
        {
            if (bungieClient.Repository.TryGetDestinyDefinition<DestinyPresentationNodeDefinition>(
