...
{
    internal class SocialCommendationDefinitionGeneratorHandler : BaseDefinitionHandler, IDefinitionHandler
    {
            ...
            int indentation)
        {
            ...
            foreach (var definition in bungieClient.Repository.GetAll<DestinySocialCommendationDefinition>())
            {
            ...
            {
                if (bungieClient.Repository.TryGetDestinyDefinition<DestinySocialCommendationDefinition>(
