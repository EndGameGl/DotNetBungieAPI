...
public class SocketCategoryDefinitionGeneratorHandler : BaseDefinitionHandler, IDefinitionHandler
{
    ...
    public async Task Generate(IBungieClient bungieClient, TextWriter textWriter, StringBuilder stringBuilder, int indentation)
    {
        ...
        foreach (var definition in bungieClient.Repository.GetAll<DestinySocketCategoryDefinition>())
        {
        ...
        {
            if (bungieClient.Repository.TryGetDestinyDefinition<DestinySocketCategoryDefinition>(
