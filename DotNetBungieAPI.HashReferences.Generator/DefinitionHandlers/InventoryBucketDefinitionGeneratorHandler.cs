...
public class InventoryBucketDefinitionGeneratorHandler : BaseDefinitionHandler, IDefinitionHandler
{
    ...
    )
    {
        ...
        foreach (
            var definition in bungieClient.Repository.GetAll<DestinyInventoryBucketDefinition>()
        )
        {
        ...
        {
            if (
                bungieClient.Repository.TryGetDestinyDefinition<DestinyInventoryBucketDefinition>(
                    value,
                    out var definition
                )
            )
