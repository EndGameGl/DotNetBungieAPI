...
public class OpenApiComponentSchema
{
    ...
    public OpenApiComponentSchema? Items { get; init; }
    ...
    public OpenApiComponentSchema? DictionaryKey { get; init; }

    [JsonPropertyName("x-mapped-definition")]
    public OpenApiComponentSchema? MappedDefinition { get; init; }

    [JsonPropertyName("allOf")]
    public List<OpenApiComponentSchema> AllOf { get; init; }
