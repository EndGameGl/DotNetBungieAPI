    ...
    public class SerializationTests
    {
        ...
        public SerializationTests()
        {
            ...
            _destinyChecklistDefinition = File.ReadAllText(
                "./JsonTestAssets/DestinyChecklistDefinition_3373333905.json"
            );
        }
        ...
        {
            var manifest = JsonSerializer.Deserialize<DestinyManifest>(
                _manifestJson,
            ...
            Assert.Equal("106284.22.06.21.1351-1-bnet.44999", manifest!.Version);
        ...
        public void DeserializeDestinyChecklistDefinition()
        {
            ...
            Assert.Equal("View Lucent Moths", destinyChecklistDefinition.ViewActionString);
