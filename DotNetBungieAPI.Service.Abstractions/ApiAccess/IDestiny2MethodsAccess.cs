...
public interface IDestiny2MethodsAccess
{
    ...
    ///     memberships due to cross save.
    /// </summary>
    /// <param name="membershipType">
    ///     A valid non-BungieNet membership type, or All. Indicates which memberships to return. You
    ///     probably want this set to All.
    /// </param>
    ...
    ///     available to 3rd-party apps, but will only work on 'free and reversible' socket actions (Perks, Armor Mods,
    ///     Shaders, Ornaments, etc.). You must have a valid Destiny Account, and the character must either be in a social
