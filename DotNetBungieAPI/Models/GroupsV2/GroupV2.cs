...
namespace DotNetBungieAPI.Models.GroupsV2
{
    public sealed record GroupV2
    {
        ...
        [JsonPropertyName("modificationDate")] public DateTime ModificationDate { get; init; }
        ...
        [JsonPropertyName("allowChat")] public bool AllowChat { get; init; }
        ...
        [JsonPropertyName("avatarImageIndex")] public int AvatarImageIndex { get; init; }

        [JsonPropertyName("homepage")] public GroupHomepage Homepage { get; init; }

        [JsonPropertyName("membershipOption")] public MembershipOption MembershipOption { get; init; }

        [JsonPropertyName("defaultPublicity")] public GroupPostPublicity DefaultPublicity { get; init; }

        [JsonPropertyName("theme")] public string Theme { get; init; }

        [JsonPropertyName("bannerPath")] public string BannerPath { get; init; }

        [JsonPropertyName("avatarPath")] public string AvatarPath { get; init; }

        [JsonPropertyName("conversationId")] public long ConversationId { get; init; }

        [JsonPropertyName("enableInvitationMessagingForAdmins")]
        public bool EnableInvitationMessagingForAdmins { get; init; }

        [JsonPropertyName("banExpireDate")] public DateTime? BanExpireDate { get; init; }

        [JsonPropertyName("features")] public GroupFeatures Features { get; init; }

        [JsonPropertyName("clanInfo")] public GroupV2ClanInfoAndInvestment ClanInfo { get; init; }
    }
}