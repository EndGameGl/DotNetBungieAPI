...
namespace DotNetBungieAPI.Models.Destiny.Definitions.Locations
{
    ...
    public sealed record DestinyLocationReleaseDefinition : IDeepEquatable<DestinyLocationReleaseDefinition>
    {
        ...
        /// <summary>
        ///     The Activity Graph Node being pointed to by this location. (Remember that Activity Graph Node hashes are only
        ///     unique within an Activity Graph: so use the combination to find the node being spoken of)
        /// </summary>
        [JsonPropertyName("activityGraphNodeHash")]
        public uint ActivityGraphNodeHash { get; init; }

        /// <summary>
        ///     The Activity Bubble within the Destination. Look this up in the DestinyDestinationDefinition's bubbles and
        ///     bubbleSettings properties.
        /// </summary>
        [JsonPropertyName("activityBubbleName")]
        public uint ActivityBubbleName { get; init; }

        /// <summary>
        ///     If we had map information, this would tell us something cool about the path this location wants you to take. I wish
        ///     we had map information.
        /// </summary>
        [JsonPropertyName("activityPathBundle")]
        public uint ActivityPathBundle { get; init; }

        /// <summary>
        ///     If we had map information, this would tell us about path information related to destination on the map. Sad. Maybe
        ///     you can do something cool with it. Go to town man.
        /// </summary>
