    ...
    public sealed record DestinyMilestoneDefinition : IDestinyDefinition, IDeepEquatable<DestinyMilestoneDefinition>
    {
        ...
        public void MapValues()
        {
            foreach (var activity in Activities)
            {
                ...
                foreach (var node in activity.ActivityGraphNodes) node.ActivityGraph.TryMapValue();

                foreach (var challenge in activity.Challenges) challenge.ChallengeObjective.TryMapValue();
            }
