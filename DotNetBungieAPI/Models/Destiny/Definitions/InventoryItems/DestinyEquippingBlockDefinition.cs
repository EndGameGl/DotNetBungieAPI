...
namespace DotNetBungieAPI.Models.Destiny.Definitions.InventoryItems
{
    ...
    public sealed record DestinyEquippingBlockDefinition : IDeepEquatable<DestinyEquippingBlockDefinition>
    {
        ...
        /// <summary>
        ///     Ammo type used by a weapon is no longer determined by the bucket in which it is contained. If the item has an ammo
        ///     type - i.e. if it is a weapon - this will be the type of ammunition expected.
        /// </summary>
        ...
        /// <summary>
        ///     These are strings that represent the possible Game/Account/Character state failure conditions that can occur when
        ...
        ///     <para />
        ///     For instance, when you aren't allowed to equip more than one Exotic Weapon, that's because all exotic weapons have
        ///     identical uniqueLabels and the game checks the to-be-equipped item's uniqueLabel vs. all other already equipped
        ///     items (other than the item in the slot that's about to be occupied).
        /// </summary>
