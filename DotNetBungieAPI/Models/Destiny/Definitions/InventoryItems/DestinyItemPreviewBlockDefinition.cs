...
/// <summary>
///     Items like Sacks or Boxes can have items that it shows in-game when you view details that represent the items you
///     can obtain if you use or acquire the item.
///     <para />
...
public sealed record DestinyItemPreviewBlockDefinition : IDeepEquatable<DestinyItemPreviewBlockDefinition>
{
    ...
    /// <summary>
    ///     If the preview data is derived from a fake "Preview" Vendor, this will be DestinyVendorDefinition of that fake
    ///     vendor.
    /// </summary>
    ...
    /// <summary>
    ///     A string that the game UI uses as a hint for which detail screen to show for the item. You, too, can leverage this
    ///     for your own custom screen detail views. Note, however, that these are arbitrarily defined by designers: there's no
    ///     guarantees of a fixed, known number of these - so fall back to something reasonable if you don't recognize it.
    /// </summary>
    [JsonPropertyName("screenStyle")]
    public string ScreenStyle { get; init; }

    /// <summary>
    ///     If this item should show you Artifact information when you preview it, this is the DestinyArtifactDefinition for
    ///     the artifact whose data should be shown.
    /// </summary>
