...
{
    /// <summary>
    ///     If an item is "instanced", this will contain information about the item's instance that doesn't fit easily into
    ///     other components. One might say this is the "essential" instance data for the item.
    ///     <para />
    ///     Items are instanced if they require information or state that can vary. For instance, weapons are Instanced: they
    ///     are given a unique identifier, uniquely generated stats, and can have their properties altered. Non-instanced items
    ///     have none of these things: for instance, Glimmer has no unique properties aside from how much of it you own.
    ///     <para />
    ...
    public sealed record DestinyItemInstanceComponent
    {
        ...
        /// <summary>
        ///     The item stat that we consider to be "primary" for the item. For instance, this would be "Attack" for Weapons or
        ///     "Defense" for armor.
        /// </summary>
        ...
        /// <summary>
        ///     If this is an equippable item, you can check it here. There are permanent as well as transitory reasons why an item
        ///     might not be able to be equipped: check cannotEquipReason for details.
        /// </summary>
        ...
        ///     <para />
        ///     This is a list of flags that they need in order to equip the item that the character has not met. Use these to look
        ...
        ///     item. You may need to refine your UI further by using unlockHashesRequiredToEquip and equipRequiredLevel.
        /// </summary>
        [JsonPropertyName("cannotEquipReason")]
        public EquipFailureReason CannotEquipReason { get; init; }

        /// <summary>
        ///     If populated, this item has a breaker type corresponding to the given value. See DestinyBreakerTypeDefinition for
        ///     more details.
        /// </summary>
        ...
        /// <summary>
        ///     If populated, this is the hash identifier for the item's breaker type. See DestinyBreakerTypeDefinition for more
        ///     details.
        /// </summary>
        ...
        /// <summary>
        ///     IF populated, this item supports Energy mechanics (i.e. Armor 2.0), and these are the current details of its energy
        ///     type and available capacity to spend energy points
        /// </summary>
