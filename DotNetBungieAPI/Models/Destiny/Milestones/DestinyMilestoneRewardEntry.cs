...
namespace DotNetBungieAPI.Models.Destiny.Milestones
{
    ...
    public sealed record DestinyMilestoneRewardEntry
    {
        ...
        ///     DestinyMilestoneRewardEntryDefinition to get the static details about the reward, which you can do by looking up
        ///     the milestone's DestinyMilestoneDefinition and examining the
        ...
        /// <summary>
        ///     If TRUE, the player has redeemed/picked up/obtained this reward. Feel free to alias this to "gotTheShinyBauble" in
        ///     your own codebase.
        /// </summary>
