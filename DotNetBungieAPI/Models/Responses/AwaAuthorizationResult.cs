...
namespace DotNetBungieAPI.Models.Responses
{
    ...
    {
        /// <summary>
        ///     Indication of how the user responded to the request. If the value is "Approved" the actionToken will contain the
        ///     token that can be presented when performing the advanced write action.
        /// </summary>
        ...
        /// <summary>
        ///     This token may be used to perform the requested action this number of times, at a maximum. If this value is 0, then
        ///     there is no limit.
        /// </summary>
