namespace DotNetBungieAPI.Models.Forum
{
    ...
    {
        [JsonPropertyName("answerText")] public string AnswerText { get; init; }

        [JsonPropertyName("answerSlot")] public int AnswerSlot { get; init; }

        [JsonPropertyName("lastVoteDate")] public DateTime LastVoteDate { get; init; }
