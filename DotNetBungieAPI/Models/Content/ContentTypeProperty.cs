...
namespace DotNetBungieAPI.Models.Content
{
    public sealed record ContentTypeProperty
    {
        ...
        [JsonPropertyName("rootPropertyName")] public string RootPropertyName { get; init; }

        [JsonPropertyName("readableName")] public string ReadableName { get; init; }
        ...
        [JsonPropertyName("localizable")] public bool Localizable { get; init; }
        ...
        [JsonPropertyName("isTitle")] public bool IsTitle { get; init; }

        [JsonPropertyName("required")] public bool Required { get; init; }

        [JsonPropertyName("maxLength")] public int MaxLength { get; init; }

        [JsonPropertyName("maxByteLength")] public int MaxByteLength { get; init; }

        [JsonPropertyName("maxFileSize")] public int MaxFileSize { get; init; }

        [JsonPropertyName("regexp")] public string Regexp { get; init; }

        [JsonPropertyName("validateAs")] public string ValidateAs { get; init; }

        [JsonPropertyName("rssAttribute")] public string RssAttribute { get; init; }

        [JsonPropertyName("visibleDependency")]
        public string VisibleDependency { get; init; }

        [JsonPropertyName("visibleOn")] public string VisibleOn { get; init; }

        [JsonPropertyName("datatype")] public ContentPropertyDataTypeEnum Datatype { get; init; }
        ...
        [JsonPropertyName("bindToProperty")] public string BindToProperty { get; init; }
        ...
        [JsonPropertyName("propertySection")] public string PropertySection { get; init; }

        [JsonPropertyName("weight")] public int Weight { get; init; }

        [JsonPropertyName("entitytype")] public string EntityType { get; init; }

        [JsonPropertyName("isCombo")] public bool IsCombo { get; init; }
        ...
        [JsonPropertyName("minWidth")] public int MinWidth { get; init; }

        [JsonPropertyName("maxWidth")] public int MaxWidth { get; init; }

        [JsonPropertyName("minHeight")] public int MinHeight { get; init; }

        [JsonPropertyName("maxHeight")] public int MaxHeight { get; init; }
